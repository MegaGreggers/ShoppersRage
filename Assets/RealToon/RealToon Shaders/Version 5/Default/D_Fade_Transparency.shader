    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
				...
				o.pos = UnityObjectToClipPos( float4(v.vertex.xyz + _OEM*((clamp(lerp( _VertexColorRedAffectOutlineWitdh_var, (_VertexColorRedAffectOutlineWitdh_var*node_1229), _OutlineWidthAffectedByViewDistance ),0.0,2000.0)*0.01)*_OutlineWidthControl_var.r*lerp(1.0,node_9863,_NoisyOutlineIntensity)),1) );
            ...
            float4 frag(VertexOutput i) : COLOR {
				...
				float3 lightColor = _LightColor0.rgb;
                float node_3413 = 0.0;
                return fixed4(lerp( _OutlineColor.rgb, lerp(float3(node_3413,node_3413,node_3413),_OutlineColor.rgb,_LightColor0.rgb), _LightAffectOutlineColor ),0);
            }
            ENDCG
        }
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                half3 node_6694 = (_LightIntensity+_LightColor0.rgb);
                ...
                half3 node_2388 = (node_7946*lerp((lerp(node_1860,(node_1860+node_6694),_LightAffectShadow)*node_938*N_F_STIS( node_5343 )),N_F_ST( lerp(((node_338+node_6694)*node_938),node_2500,lerp(node_4736,smoothstep( node_6045, node_3187, ((_ShadowT_var.r*(1.0 - _ShadowTShadowThreshold))*(lerp( node_573, (attenuation*node_573), _LightFalloffAffectShadowT )*_ShadowTLightThreshold)) ),_ShadowTIntensity)) , node_2500 ),N_F_SS( lerp(node_5901,(lerp( node_9545, lerp(node_9545,node_5901,C_SS()), _SelfShadowAffectedByLightShadowStrength )*attenuation),_SelfShadowIntensity) , lerp(node_5901,attenuation,_SelfShadowIntensity) )));
                ...
                half3 node_5922 = ((node_7946*N_F_SL( lerp(node_9546,lerp(node_9546,((_SelfLitColor.rgb*node_7946*lerp( 1.0, node_7946, _SelfLitHighContrast ))*_SelfLitPower),_MaskSelfLit_var.r),_SelfLitIntensity) , node_9546 )*N_F_STIAL( lerp(lerp(float3(node_3456,node_3456,node_3456),node_5343,_ShowInAmbientLightIntensity),float3(node_4824,node_4824,node_4824),clamp((node_938*8.0),0,1)) ))+N_F_RL( lerp((node_7395+node_4858),node_7395,_RimLightInLight) , node_7395 ));
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                half3 node_7395 = N_F_SL_1( lerp(node_2704,lerp(node_2704,node_7946,_MaskSelfLit_var.r),_SelfLitIntensity) , node_2704 );
                half3 node_5922 = ((node_7946*N_F_SL( lerp(node_9546,lerp(node_9546,((_SelfLitColor.rgb*node_7946*lerp( 1.0, node_7946, _SelfLitHighContrast ))*_SelfLitPower),_MaskSelfLit_var.r),_SelfLitIntensity) , node_9546 )*N_F_STIAL( lerp(lerp(float3(node_3456,node_3456,node_3456),node_5343,_ShowInAmbientLightIntensity),float3(node_4824,node_4824,node_4824),clamp((node_938*8.0),0,1)) ))+N_F_RL( lerp((node_7395+node_4858)*lightfos,node_7395,_RimLightInLight) , node_7395 ));
                float3 finalColor = N_F_CA( lerp(node_5922,dot(node_5922,float3(0.3,0.59,0.11)),(1.0 - _Saturation)) , node_5922 );
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
				...
				float dither = tex3D(_DitherMaskLOD, float3(i.opos.xy * 256, node_7861 * 0.99)).a;
