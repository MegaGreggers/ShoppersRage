...
namespace RootMotion {
	...
	public class CameraController : MonoBehaviour {
		...
		public float zoomSpeed = 5f; // The speed of interpolating the distance
		public float zoomSensitivity = 0.5f; // The sensitivity of mouse zoom
		...
		public void UpdateInput() {
			...
			// delta rotation
			if (rotate) {
				x += Input.GetAxis("R_XAxis_1") * rotationSensitivity;
				y = ClampAngle(y + Input.GetAxis("R_YAxis_1") * rotationSensitivity, yMinLimit, yMaxLimit);
			}
		...
		private float zoomAdd {
			get {
				float scrollAxis = Input.GetAxis("R_YAxis_1");
